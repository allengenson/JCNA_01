...
const PhoneIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4A7C2F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-10 xl:gap-8">
              ...
              <div>
                ...
                <p className="font-dm mb-4" style={{ fontSize: "14px", color: "#4A7C2F", lineHeight: 1.7 }}>
                  Gather with us every Sunday for spirit-led worship, inspiring messages, and genuine community. All are welcome.
                </p>
                <p style={labelStyle}>MAIN CHURCH</p>
                <p className="font-dm mb-4" style={{ fontSize: "14px", color: "#4A7C2F", lineHeight: 1.7 }}>
                  Natalio B. Bacalso National Highway,<br />
                  Upper Tulay, Minglanilla, Cebu, Philippines<br />
                ...
                <div className="flex items-center gap-2">
                  <MailIcon />
                  <span style={{ ...contactTextStyle, wordBreak: "break-all" }}>onefoldassembly@gmail.com</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{ width: "100%", maxWidth: "214px", border: "1px solid rgba(74,124,47,0.20)", borderRadius: "5px", overflow: "hidden" }}>
              ...
              <div>
                ...
                <div className="flex flex-col gap-3 mb-6">
                  {["Plan your visit"].map((item) => (
                    <button key={item} onClick={() => handleGetInvolvedClick(item)} style={navLinkStyle}>{item}</button>
                  ))}
                </div>
                <div style={{ width: "100%", maxWidth: "210px", background: "rgba(130,182,87,0.40)", borderRadius: "8px", padding: "16px 18px" }}>
                  <p className="font-dm" style={{ fontSize: "14px", color: "#4A7C2F", marginBottom: "6px" }}>Submit a Prayer Request</p>
                  <p className="font-dm" style={{ fontSize: "12px", color: "#4A7C2F", lineHeight: 1.6, marginBottom: "12px" }}>
                    We believe in the power of prayer.<br />Share your needs with our team.
                  </p>
                  <button onClick={() => setPrayerOpen(true)} style={{ display: "inline-flex", alignItems: "center", gap: "4px", fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: "10px", color: "#D4A017", background: "none", border: "none", borderBottom: "1px solid #D4A017", cursor: "pointer", padding: "0 0 3px 0" }}>
              ...
              <div>
                ...
                <a href="https://www.youtube.com/@JCNA777" target="_blank" rel="noopener noreferrer" style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 400, fontSize: "14px", color: "#4A7C2F", textDecoration: "none" }}>
                  Watch live stream
                </a>
              </div>
