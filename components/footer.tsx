    ...
    <div className="w-full bg-[#F6F8F1] py-5">
      <div className="mx-auto w-full max-w-[1418px] px-6 lg:px-12">
        <div className="bg-white border border-[#82B657] rounded-[24px] p-8 md:px-9 md:py-8">
                ...
                <div className="flex gap-[28px]">
                  {["Home", "Who we are"].map((item) => (
                    <button
                      ...
                      className="font-dm font-normal text-[14px] text-[#4A7C2F] bg-transparent border-none p-0 text-center cursor-pointer hover:text-[#2D5016]"
                    >
                      {item}
                    </button>
                  ))}
          ...
          {/* Divider + Copyright */}
          <div className="border-t border-[#E2EDD6] mt-[24px] pt-[16px] text-center">
